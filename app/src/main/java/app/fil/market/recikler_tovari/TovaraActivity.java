...
public class TovaraActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String userName = intent.getStringExtra(TovariAdapter.KEY_NAME);
        String image = intent.getStringExtra(TovariAdapter.KEY_IMAGE);
        final String profileUrl = intent.getStringExtra(TovariAdapter.KEY_URL);
