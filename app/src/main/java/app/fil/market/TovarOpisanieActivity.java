...
//        TovariActivity.setStartCountKorzina(tvKorzinaCount);
        ...
        tvOpisVKorzinu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                buySQL(PodkategoriiFragment.listTovarovSQLfromAdapterRV.get(Integer.valueOf(PodkategoriiFragment.podkatVetkaId)).get(TovariSpisokAdapter.indexTovaraDliaOpisanieFragment).getId_sql_tovara_v_baze(), etKolvo.getText().toString(),
